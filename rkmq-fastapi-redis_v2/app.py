...
def handle_split_mixer_task(task_info: dict):
    ...
    "min_duration": data.get("min_duration", 20),
    "max_duration": data.get("max_duration", 45),
...
def handle_mixer_task(task_info: dict):
    ...
    "input_folder": data.get("input_folder"),
    "output_folder": data.get("output_folder"),
    "ttf_path": data.get("ttf_path", "fonts/default.ttf"),
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run(app="app_v2:app", host="0.0.0.0", port=8000, reload=True)