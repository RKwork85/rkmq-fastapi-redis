...
class VideoCombinator:
    def __init__(self, input_folder, output_folder, min_duration=60, max_duration=300, 
                 max_clips_per_video=5, max_videos=50, max_usage=3,ttf_path="assets/fonts/汉仪晓波花月圆W.ttf", logger=None):
        """
        初始化视频组合器
...
def run_video_combinator(params: dict):
    ...
    try:
        ...
        # main() 或其他处理函数
        # 从 data 获取所有参数
        input_folder = params.get("input_folder", "catoutput/baby_cat/")
        ...
        ttf_path = params.get("ttf_path", "assets/fonts/汉仪晓波花月圆W.ttf")
